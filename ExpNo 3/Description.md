...
3.  while the open list is not empty
   ...
   successor.g = q.g + distance between successor and q successor.h = distance from goal to  successor (This can be done using many  ways, we will discuss three heuristics- Manhattan, Diagonal and Euclidean Heuristics)      
...
```
## OUTPUT:
![image](https://github.com/chetansathishkumar/19AI405FUNDAMENTALSOFARTIFICIALINTELLIGENCE/assets/75260837/35b1cd14-ee1d-4f51-9877-456c7e6fe109)
## RESULT:
